...
CREATE TABLE `realisasi` (
  ...
  `ganti_meter` tinyint(1) DEFAULT NULL,
  `ganti_modem` tinyint(1) DEFAULT NULL,
  `ganti_sim` tinyint(1) DEFAULT NULL,
  `ganti_pembatas_arus` tinyint(1) DEFAULT NULL,
  `ganti_ct` tinyint(1) DEFAULT NULL,
  `kesimpulan` tinyint(1) DEFAULT NULL,
  `tanggal` date DEFAULT NULL,
  `arus_r` varchar(6) DEFAULT NULL,
  `arus_s` varchar(6) DEFAULT NULL,
  `arus_t` varchar(6) DEFAULT NULL,
  `tegangan_r` varchar(6) DEFAULT NULL,
  `tegangan_s` varchar(6) DEFAULT NULL,
  `tegangan_t` varchar(6) DEFAULT NULL,
  `stand_total` varchar(12) DEFAULT NULL,
...
--
-- Table structure for table `target_operasional`
--

CREATE TABLE `target_operasional` (
  `id_target_operasional` int(11) NOT NULL,
  `id_pelanggan` varchar(14) NOT NULL,
...
ALTER TABLE `target_operasional`
  ADD PRIMARY KEY (`id_target_operasional`);
...
--
ALTER TABLE `target_operasional`
  MODIFY `id_target_operasional` int(11) NOT NULL AUTO_INCREMENT;
