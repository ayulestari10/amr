...
<head>
<meta charset="utf-8"/>
<title><?= $title ?> | Sistem Manajemen Pemeliharan AMR dan APP</title>
...
<link href="<?= base_url('assets/metronic') ?>/assets/global/plugins/select2/select2.css" rel="stylesheet" type="text/css"/>
<link href="<?= base_url('assets/metronic') ?>/assets/admin/pages/css/login3.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.html">
	<img src="<?= base_url('assets/metronic') ?>/assets/admin/layout4/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
