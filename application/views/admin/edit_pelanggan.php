		...
		<div class="col-md-12">
			<div class="portlet box blue" id="form_wizard_1">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-gift"></i> Edit Pengguna - <span class="step-title">
						Step 1 of 6 </span>
					</div>
				...
				<div class="portlet-body form">
					<?= form_open_multipart('admin/edit-pelanggan', ['class' => 'form-horizontal', 'id' => 'submit_form']) ?>
							...
							<div class="form-body">
								...
								<div class="tab-content">
									...
									<div class="tab-pane active" id="tab1">
										<h3 class="block">Edit Data Pengguna</h3>
										<hr>
										...
										<hr>
										<h3 class="block">Edit Data Pelanggan</h3>
										<hr>		
									...
									<div class="tab-pane" id="tab2">
										<h3 class="block">Edit Data Meter</h3>
										<div class="form-group">
									...
									<div class="tab-pane" id="tab3">
										<h3 class="block">Edit Data Modem</h3>
										<div class="form-group">
									...
									<div class="tab-pane" id="tab4">
										<h3 class="block">Edit Data SIM Card</h3>
										<div class="form-group">
									...
									<div class="tab-pane" id="tab5">
										<h3 class="block">Edit Data Pembatas Arus</h3>
										<div class="form-group">
											<label class="control-label col-md-3">Merk<span class="required">
											* </span>
											</label>
									...
									<div class="tab-pane" id="tab6">
										<h3 class="block">Edit Data CT</h3>
										<div class="form-group">
